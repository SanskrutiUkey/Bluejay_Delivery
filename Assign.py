...
def analyze_excel_file(file_path, consecutive_days_threshold=7):
    try:
        ...
        for index, row in df.iterrows():
            ...
            if employee_name in consecutive:
                continue
        ...
        for index, row in df.iterrows():
            ...
            if employee_name in short_break:
                continue
        ...
        for index, row in df.iterrows():
            ...
            if employee_name in long_shift:
                continue
...
if __name__ == "__main__":
    ...
    file_path = 'C:\\Users\\DELL\\Bluejay Delivery\\Assignment_Timecard.xlsx'
